...
from GPyM.parse_fname_trmm import parse_fname_trmm
from GPyM.parse_fname_gpm import parse_fname_gpm
...
def get_path(srcDir, sDTime, eDTime):
    ...
    srcDIR = [os.path.join(srcDir, str(y), '%02d' % m)
              ...
              for m in range(1, 13)]
    srcDIR = srcDIR[sDTime.month-1: eDTime.month -
                    12 if eDTime.month != 12 else 12]
    # +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
